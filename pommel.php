<?php
echo('<html>');
echo('<head><title>Pommel</title></head>');
...
$showScores = "select name as 'Name', club as 'Club', score as 'Score', dif as 'Dif', app as 'Ap', correction as ' ' from scores s, athletes a where pid = id and app='PH' order by score desc";
